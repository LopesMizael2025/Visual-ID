 ...
 * composição solta × padrões oficiais do Praia Clube.
 * Peças fornecidas pela equipe de marketing como demonstração.
 */

const criterios = [
  { n: "01", t: "Fundo preto e grafismo do manual" },
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <Reveal delay={1}>
          <p className="mt-6 max-w-2xl text-lg font-light leading-relaxed text-white/55 md:text-xl">
            ...
            solta × os padrões oficiais do Praia — fundo preto, grafismo do
            manual e assinatura do clube.
          </p>
        </Reveal>
        ...
        <Reveal delay={1} className="mt-12">
          ...
          <div className="mx-auto max-w-md md:max-w-lg">
            <BeforeAfter
              aspectClass="aspect-[900/1272]"
              before={
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src="/prova-visual/acess-sem-direcao.webp"
                  alt="Peça da campanha de acessibilidade em fundo claro, composição fora do padrão"
              ...
              after={
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src="/prova-visual/acess-com-identidade.webp"
                  alt="Peça da campanha de acessibilidade nos padrões oficiais do Praia Clube"
                  className="h-full w-full object-cover"
                />
              }
          ...
          <p className="mt-3 text-center text-[10px] font-medium uppercase tracking-[0.25em] text-white/30">
            Campanha de acessibilidade · referências: feed @praiaclubeoficial e Manual de Marca
          </p>
        </Reveal>
